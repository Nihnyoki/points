Feature: Points / MindMap service
  ...
  Scenario: post a point to the point service using any person
    ...
    When this person posts a point with below details:
      ...
      | point_note      | MThere is an inflight majik rule that helps your brain to reform when using using snuff, perhaps use it less frequently. For now, lets go back to the black one. |
